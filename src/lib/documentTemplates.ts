		...
		sections: [
			{
				...
				guidancePrompt:
					"Write a compelling executive summary that captures the business opportunity, solution, and key metrics. Keep it concise (1-2 pages).",
			...
			},
			{
				...
				guidancePrompt:
					"Describe the problem your business solves and your unique solution. Be specific about pain points and how you address them.",
				estimatedTokens: 400,
			},
			{
				id: "market-analysis",
			...
			},
			{
				...
				guidancePrompt:
					"Explain how the business makes money. Include pricing strategy, revenue streams, and unit economics.",
				estimatedTokens: 400,
			},
			{
				id: "go-to-market",
			...
			},
			{
				...
				guidancePrompt:
					"Provide 3-5 year financial projections including revenue, expenses, and profitability timeline.",
				estimatedTokens: 500,
			},
			{
				id: "team",
		...
		sections: [
			{
				...
				title: "Abstract",
				guidancePrompt:
					"Write a concise abstract (150-250 words) summarizing the research question, methodology, key findings, and implications.",
				estimatedTokens: 300,
			},
			{
				id: "introduction",
				title: "Introduction",
				guidancePrompt:
					"Introduce the research topic, background, and research question. Explain why this research matters.",
				estimatedTokens: 500,
			},
			{
			...
			},
			{
				...
				title: "Results",
				guidancePrompt:
					"Present the research findings clearly. Use tables, charts, or structured data where appropriate.",
				estimatedTokens: 600,
			},
			{
				id: "discussion",
