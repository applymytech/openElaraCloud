...
export function getMoodEmotionalContext(moodState: MoodState | null, characterName: string): string | null {
	...
	const moodValue = moodState.currentMood ?? moodState.level;
	const mood = typeof moodValue === 'string' ? parseFloat(moodValue) : moodValue;
