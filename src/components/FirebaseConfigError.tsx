    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          When you deploy to Firebase Hosting with <code>firebase deploy</code>, 
          the configuration is automatically injected. This error only appears 
          during local development without proper environment setup.
        </div>
