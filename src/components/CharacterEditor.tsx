            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => updateField('voiceProfile', { 
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => updateField('emotionalProfile', { 
  ...
  return (
    <div className="character-selector">
      ...
      <p className="selector-hint">
        Select an AI character to chat with. Custom characters get all the same features!
      </p>
        ...
        {characters.map((char) => (
          ...
          >
            <div className="card-main">
              ...
              <div className="card-info">
                ...
                <div className="card-description">
                  {char.descriptionSafe.slice(0, 80)}...
                </div>
              </div>
            </div>
            ...
            <div className="card-actions">
              ...
              {!char.isBuiltIn && (
                <button 
                  onClick={(e) => { e.stopPropagation(); handleDeleteCharacter(char); }}
