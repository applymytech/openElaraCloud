...
async function chatWithTogether(
  ...
  try {
    ...
    console.log(`[Together] Sending request to model: ${payload.modelConfig.modelId}`);
...
async function chatWithOpenRouter(
  ...
  try {
    ...
    console.log(`[OpenRouter] Sending request to model: ${payload.modelConfig.modelId}`);
...
async function chatWithOpenAIStyle(
  ...
  try {
    ...
    console.log(`[OpenAI-Style] Sending request to ${endpoint} model: ${payload.modelConfig.modelId}`);
...
export async function chat(
  ...
  // Return in OpenAI-compatible format for backwards compatibility
  return {
    choices: [{
      message: {
        role: 'assistant',
